...
function initWorld() {
    ...
    enemies.push(new Enemy(5200, bottomPos - 800 - 30, 30, 30, "red", GAME.context, 5200, 5200 + 200));
...
function generalBehaviors() {
    ...
    // Verificar si el jugador ha ganado la carrera
if (jugador.x + jugador.width > platforms[platforms.length - 1].x + platforms[platforms.length - 1].width - 200) {
    GAME.finish();
